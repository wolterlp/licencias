...
/**
 * Busca licencias que expiran exactamente en 15 días
 */
...
const sendExpirationEmail = async (license) => {
  try {
    ...
    const info = await transporter.sendMail({
      ...
      to: license.email,
      subject: '⚠️ Aviso Importante: Su licencia expira en 15 días',
      ...
      html: `
        <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
            ...
            <div style="background-color: #fffbeb; padding: 15px; border-radius: 5px; border: 1px solid #fcd34d; margin: 20px 0;">
                ...
                <p style="margin: 10px 0 0 0; color: #b45309;">Quedan 15 días de servicio.</p>
            </div>
